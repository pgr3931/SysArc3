...
public class BallsFilterBeanInfo extends SimpleBeanInfo {
    private static final Class beanClass = BallsFilter.class;

    @Override
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor prop1 = new PropertyDescriptor("radius", beanClass);
